...
const FT = new caver.klay.KIP7(DEPLOYED_ADDRESS_TOKEN7)
const NFT = new caver.klay.KIP17(DEPLOYED_ADDRESS_PRODUCTS)

const getContractInstanceToken7 = () => {
  const contractInstance = deployedABIToken7 && DEPLOYED_ADDRESS_TOKEN7 && new caver.contract(deployedABIToken7, DEPLOYED_ADDRESS_TOKEN7)
  return contractInstance
}

const getContractInstanceProducts = () => {
  const contractInstance = deployedABIProducts && DEPLOYED_ADDRESS_PRODUCTS && new caver.contract(deployedABIProducts, DEPLOYED_ADDRESS_PRODUCTS)
  return contractInstance
}

const getContractInstanceTrade = () => {
  const contractInstance = deployedABITrade && DEPLOYED_ADDRESS_TRADE && new caver.contract(deployedABITrade, DEPLOYED_ADDRESS_TRADE)
  return contractInstance
}

export { caver, getContractInstanceToken7, getContractInstanceProducts, getContractInstanceTrade, NFT, FT }
