...
const resolvers = {
  ...
  Mutation: {
    ...
    async signIn(root, { input }) {
      ...
      const tokenInfo = { _id: userObj._id, email: userObj.email, name: userObj.name, homeAddress: userObj.homeAddress, klayAddress: userObj.klayAddress, klayPrivateKey: userObj.klayPrivateKey }
